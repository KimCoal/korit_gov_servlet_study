...
public class HttpMethodServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("요청 파라미터 >>> " + req.getParameter("datasKey"));
        // 요청
...
//        resp.setCharacterEncoding(StandardCharsets.UTF_8.name());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("요청 쿼리 파라미터 >>> " + req.getParameter("keyName"));
        System.out.println("요청 쿼리 파라미터 >>> " + req.getParameter("value"));
        datas.put(req.getParameter("keyName"), req.getParameter("value"));

        System.out.println(datas.toString());

        // 응답
        resp.setStatus(201); // 리소스가 잘 생성되었다는 코드
        resp.setContentType("text/html; charset=UTF-8");
